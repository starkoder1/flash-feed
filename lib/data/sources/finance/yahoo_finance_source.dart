   ...
   Future<List<NewsItem>> fetchNews() async {
    ...
    try {
      ...
      for (final item in items) {
        ...
        final source = item.findElements('source').firstOrNull?.text ?? 'Yahoo Finance';
        
        // Find <category> tag's text, default to 'Finance'
        final category = item.findElements('category').firstOrNull?.text ?? 'Finance';
      ...
      print('Error in YahooFinanceNewsSource.fetchNews: $e');
