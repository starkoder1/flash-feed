   ...
   Future<List<NewsItem>> fetchNews() async {
    ...
    try {
      ...
      for (final item in items) {
        ...
        final source = item.findElements('source').firstOrNull?.text ?? 'Yahoo News';
        
        // Find <category> tag's text, default to 'World'
        final category = item.findElements('category').firstOrNull?.text ?? 'World';
      ...
      print('Error in YahooWorldNewsSource.fetchNews: $e');
